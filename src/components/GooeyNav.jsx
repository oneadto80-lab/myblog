        ...
        <nav
          ...
          <ul
            ...
            style={{
              ...
              gap: 'clamp(0.1rem, 1.3vw, 1.25rem)',
              paddingLeft: 0,
              paddingRight: 0,
              color: 'white',
            ...
            {items.map((item, index) => (
              <li
                ...
                <a
                  ...
                  className="outline-none py-[0.6em] px-[1em] inline-flex items-center justify-center"
                  style={{
                    minWidth: 44,
                    paddingLeft: 'clamp(0.35em, 1vw, 1em)',
                    paddingRight: 'clamp(0.35em, 1vw, 1em)'
                  }}>
                  {item.label}
                </a>
              </li>
