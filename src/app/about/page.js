...
const ABOUT_PARAGRAPHS = [
  ...
  "界面动效由 Framer Motion 负责，包括页面入场、元素过渡和局部交互反馈。视觉背景与交互组件主要来自 React Bits：About 页面使用 PixelSnow 营造像素雪背景，Projects 页面与项目详情页使用 Ballpit 作为动态画布背景，作品入口使用 Folder 组件完成收纳式项目导航，导航栏则引入 GooeyNav 增强按钮切换时的流体反馈。",
